    ...
    <div className='vw-100 vh-100 d-flex align-items-center justify-content-center flex-column quoteStyling'>
        <div className='box px-3 py-3 mx-auto text-center'>
            <div className='box-val'>
                <h1 className=' fw-bold py-2 text-success' style={{textShadow:"3px 3px cyan"}}>Quote of the day!</h1>
                <h3 className=' fw-bold  dancing-script text-success' style={{textShadow:"3px 3px cyan"}}>"{data.quote}"</h3>
                <h6 className='text-decoration-underline fw-bold py-1 text-success' style={{textShadow:"3px 3px cyan"}}>By {data.author}</h6>
